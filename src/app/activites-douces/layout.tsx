  ...
  return (
    ...
    >
      ...
      <body className="text-black-950 bg-white antialiased">
        <ThemeProviders>
          <Header />
          <VideoHeroBanner /*remoteFileUrl="https://ri0bt5s1ncgotyco.public.blob.vercel-storage.com/activites_douces.mp4"*/ filename="activites_douces.mp4" />
          <SectionContainer>
