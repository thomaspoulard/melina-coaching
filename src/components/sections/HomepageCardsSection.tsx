        ...
        {introductionContent.activities.map((activity, i) => {
          return <button key={i} onClick={() => router.push(activity.path)} className="h-full cursor-pointer z_shadow-primary group">
            <div className='relative h-full'>
              ...
              <ArrowOutwardSharpIcon className='text-white absolute right-3 top-3' />
              <div className='bg-white text-primary font-thin text-sm sm:text-lg xl:text-xl 2xl:text-2xl h-12 absolute flex justify-center items-center bottom-6 -right-1 pl-[22px] pr-[10px] sm:pl-[25px] w-max-content opacity-100 group-hover:opacity-100 transition-opacity duration-150 ease-out parallelogram group-hover:z_shadow-primary'>
